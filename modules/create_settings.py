...
def create_game_objects(settings):
    settingContainer = SettingContainer(create_settings_from_file(settings.get("language", "en")), settings=settings)
    players = Players(settingContainer, kwargs=settings)
    return players, settingContainer
